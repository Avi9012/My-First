...
public class hotelAdapter extends ExpandableRecyclerAdapter<ModelhotelViewHolder, Hotel_detailsViewHolder> {
      ...
      LayoutInflater inflater;                                                             //layout inflater is used to instantiate layout xml file in corresponding view objects

    public hotelAdapter(Context context, List<ParentObject> parentItemList) {
        super(context, parentItemList);
        inflater = LayoutInflater.from(context);                                         // obtains the layout inflater from given context
    }
    ...
    @Override
    public void onBindChildViewHolder(Hotel_detailsViewHolder hotel_detailsViewHolder, int i, Object o) {                              //here we bind data with view older

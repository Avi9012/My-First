...
public class tourAdapter extends RecyclerView.Adapter<tourAdapter.MyViewHolder1> {
    ...
    public MyViewHolder1 onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        LayoutInflater layoutInflater = LayoutInflater.from(context);                                                         //LayoutInflater is used to manipulate Android screen using predefined XML layouts. This class is used to instantiate layout XML file into its corresponding View objects.
